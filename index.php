        ...
        <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="php/login/login.php">Log In</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <main class="bg-light">
                ...
                <div class="text-center pt-5 mt-5">
                    <h1 class="mt-3">Welcome to Language School Faltin</h1>
                </div>
            ...
            <footer class="bg-body-tertiary text-center bg-dark">
                ...
                <div class="text-center p-3 text-muted" style="background-color: rgba(0, 0, 0, 0.05);">
                    © 2024 Copyright
                    <a class="text-body text-muted" href="http://ondrejfaltin.cz">ondrejfaltin.cz</a>
                </div>
